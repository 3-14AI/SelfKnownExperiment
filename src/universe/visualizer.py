            ...
            if 0 <= entity.x < self.universe.width and 0 <= entity.y < self.universe.height:
                ...
                if getattr(entity, 'is_infected', False):
                    ...
                    if getattr(entity, 'is_spiteful', False):
                        char = '%'
                    elif getattr(entity, 'is_spring_dancer', False):
                        char = '✿'
                        ...
                        char = 'L'
                    elif getattr(entity, 'is_web_dweller', False):
                        char = 'θ'
                    elif getattr(entity, 'is_cave_dweller', False):
                        char = 'C'
                    elif getattr(entity, 'is_wall_dweller', False):
                        char = 'W'
                    elif getattr(entity, 'is_lava_dweller', False):
                        char = 'L'
                    elif getattr(entity, 'is_spring_dweller', False):
                        char = 'p'
                    elif getattr(entity, 'is_summer_dweller', False):
                        char = 'u'
                    elif getattr(entity, 'is_autumn_dweller', False):
                        char = 'a'
                    elif getattr(entity, 'is_winter_dweller', False):
                        char = 'i'
                        ...
                        char = '@'
                    elif getattr(entity, 'is_fire_dancer', False):
                        char = 'F'
                        ...
                        char = 'Ð'
                    elif getattr(entity, 'is_storm_strider', False):
                        char = 'Ϟ'
                    elif getattr(entity, 'is_grass_strider', False):
                        char = 'ɣ'
                        ...
                        char = 'Ź'
                    elif getattr(entity, 'is_earthquake_strider', False):
                        char = 'ē'
                    elif getattr(entity, 'is_volcanic_strider', False):
                        char = 'ṽ'
                        ...
                        char = 'Ł'
                    elif getattr(entity, 'is_day_strider', False):
                        char = '☼'
                        ...
                        char = 'ń'
                    elif getattr(entity, 'is_marsh_dweller', False):
                        char = 'ŵ'
                    elif getattr(entity, 'is_marsh_dancer', False):
                        char = 'ŭ'
                        ...
                        char = 'Ň'
                    elif getattr(entity, 'is_quicksand_dancer', False):
                        char = '¿'
                        ...
                        char = 'ŗ'
                    elif getattr(entity, 'is_grass_walker', False):
                        char = 'Ř'
                    elif getattr(entity, 'is_parasite_dancer', False):
                        char = 'Ŕ'
