...
class Universe:
    ...
    def move_entity(self, entity, dx, dy):
        ...
        if any(t.terrain_type == 'web' for t in terrains_here) and not getattr(entity, 'can_spin_webs', False) and not getattr(entity, 'is_web_walker', False):
            if hasattr(entity, 'stamina'):
