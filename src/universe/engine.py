            ...
            if entity.is_alive:
                ...
                if getattr(entity, 'can_hoard', False) and entity.energy <= entity.max_energy * 0.5:
                    ...
                    if hoarded_foods:
                        ...
                        energy_gain = food_to_eat.energy * (2 if getattr(entity, "is_frugivore", False) and getattr(food_to_eat, "plant_type", "") == "fruit" else 1)
