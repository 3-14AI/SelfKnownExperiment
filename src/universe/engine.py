...
class Entity:
    ...
    def __init__(self, name, x=0, y=0, energy=10, age=0, max_age=50, perception_radius=10, diet='herbivore', preferred_temperature=20, temperature_tolerance=40, is_infected=False, infection_time=0, species=None, symbiotic_with=None, attack=1, defense=1, preferred_terrain=None, size=1, intelligence=1, inventory=None, target_species=None, target_plants=None, generation=0, mutations=0, hydration=50, max_hydration=50, is_sleeping=False, is_aquatic=False, is_flying=False, toxicity=0, poison_resistance=0, poisoned_time=0, camouflage=0.0, vision_type='normal', can_hibernate=False, lays_eggs=False, level=1, experience=0, can_hoard=False, max_stamina=50, stamina=50, is_nocturnal=False, can_burrow=False, has_spikes=False, can_spin_webs=False, is_venomous=False, can_photosynthesize=False, is_amphibious=False, has_shell=False, has_echolocation=False, is_aposematic=False, is_fruiting=False, is_immune=False, is_cold_blooded=False, is_electric=False, stunned_time=0, is_regenerative=False, has_claws=False, is_parasitic=False, has_scales=False, has_fur=False, can_climb=False, pack_hunter=False, has_bioluminescence=False, is_volcanic=False, is_forestal=False, is_desertic=False, is_social=False, is_carnivorous_plant=False, disease_vector=False, is_nocturnal_predator=False, is_scentless=False, can_sprint=False, is_vampiric=False, is_detritivore=False, can_sweat=False, has_blubber=False, is_mud_bather=False, is_filter_feeder=False, is_gluttonous=False, is_solitary=False, is_cannibalistic=False, is_ambush_predator=False, is_territorial=False, has_horns=False, is_migratory=False, is_cooperative=False, is_frugivore=False, is_agile=False, has_strong_stomach=False, is_opportunistic=False, has_thick_skin=False, has_sharp_teeth=False, is_hardy=False, is_fast_learner=False, is_playful=False, is_heavy_sleeper=False, is_patient=False, is_endurance_runner=False, is_evasive=False, is_prolific=False, is_adaptable=False, is_resourceful=False, is_vocal=False, is_nest_builder=False, is_nomadic=False, is_photosensitive=False, is_fearless=False, is_scavenger=False, is_scout=False, is_intimidating=False, is_cleaner=False, is_spiteful=False, is_sunbather=False, is_pack_mule=False, is_reckless=False, is_thief=False, is_absorbent=False, is_toxic=False, is_vibrant=False, is_arctic=False, is_fierce=False, is_lucky=False, is_telepathic=False, is_cautious=False, is_restless=False, is_vengeful=False, is_defensive=False, is_sturdy=False, is_slippery=False, can_leap=False, is_heavy=False, is_lightweight=False, is_stealthy=False, is_mimic=False, is_resilient=False, is_smelly=False, is_relentless=False, is_parasite_resistant=False, is_ruthless=False, is_protective=False, is_forager=False, is_tireless=False, is_vigilant=False, is_pacifist=False, is_farsighted=False, is_chameleon=False, is_bloodthirsty=False, is_unappetizing=False, is_introspective=False, is_frenzied=False, is_sun_tracker=False, is_hypnotic=False, is_tracker=False, is_empathic=False, is_contagious=False, is_arboreal=False, is_stargazer=False, is_sure_footed=False, is_dust_bather=False, is_magnetic=False, is_drought_resistant=False, is_moon_bather=False, is_storm_chaser=False, is_shadow_stalker=False, is_pyrophilic=False, is_desperate=False, is_iron_willed=False, is_frost_walker=False, is_marsh_strider=False, is_dune_walker=False, is_water_strider=False, is_web_walker=False, is_ash_walker=False, is_wind_glider=False, is_forest_walker=False, is_rain_dancer=False, is_blizzard_glider=False, is_seismic_sensitive=False, is_mud_glider=False, is_drought_strider=False, is_earthquake_glider=False, is_volcanic_glider=False, is_ice_glider=False, is_day_glider=False, is_night_glider=False, is_snow_glider=False, is_deep_water_glider=False, is_ash_glider=False, is_spring_glider=False, is_summer_glider=False, is_autumn_glider=False, is_winter_glider=False, is_wall_glider=False, is_rain_glider=False, is_sand_glider=False, is_fire_glider=False, is_web_glider=False, is_forest_glider=False, is_water_glider=False, is_shelter_glider=False, is_mountain_walker=False, is_mountain_glider=False, is_mountain_dweller=False, is_sand_dweller=False, is_forest_dweller=False, is_water_dweller=False, is_ice_dweller=False, is_ash_dweller=False, is_snow_dweller=False, is_mud_dweller=False, is_web_dweller=False, is_deep_water_dweller=False, is_cave_dweller=False, is_wall_dweller=False, is_cave_glider=False, is_cave_walker=False, is_blizzard_dweller=False, is_storm_dweller=False, is_day_dweller=False, is_night_dweller=False, is_spring_dweller=False, is_summer_dweller=False, is_autumn_dweller=False, is_winter_dweller=False, is_drought_dweller=False, is_earthquake_dweller=False, is_volcanic_dweller=False, is_fire_dweller=False, is_rain_dweller=False, is_disease_dweller=False, is_poison_dweller=False, is_venom_resistant=False, is_ageless=False, is_disease_resistant=False, is_parasite_dweller=False, is_stun_dweller=False, is_sleep_dweller=False, is_snow_walker=False, is_blizzard_walker=False, is_storm_walker=False, is_rain_walker=False, is_volcanic_walker=False, is_earthquake_walker=False, is_fire_walker=False, is_drought_walker=False, is_mud_walker=False, is_sand_walker=False, is_water_walker=False, is_storm_glider=False, is_ice_walker=False, is_lava_walker=False, is_lava_glider=False, is_night_walker=False, is_deep_water_walker=False, is_wall_walker=False, is_day_walker=False, is_spring_walker=False, is_summer_walker=False, is_autumn_walker=False, is_winter_walker=False, is_shelter_walker=False, is_drought_glider=False, is_lava_dweller=False, is_space_dweller=False, is_shelter_dweller=False, is_fire_dancer=False, is_snow_dancer=False, is_storm_dancer=False, is_blizzard_dancer=False, is_earthquake_dancer=False, is_volcanic_dancer=False, is_drought_dancer=False, is_spring_dancer=False, is_summer_dancer=False, is_autumn_dancer=False, is_winter_dancer=False, is_day_dancer=False, is_night_dancer=False, is_moon_dancer=False, is_weather_sensitive=False, is_sand_dancer=False, is_cave_dancer=False, is_water_dancer=False, is_forest_dancer=False, is_ash_dancer=False, is_mud_dancer=False, is_ice_dancer=False, is_mountain_dancer=False, is_deep_water_dancer=False, is_lava_dancer=False, is_wall_dancer=False, is_web_dancer=False, is_shelter_dancer=False, is_wind_dancer=False, is_stun_dancer=False, is_poison_dancer=False, is_parasite_dancer=False, is_sleep_dancer=False, is_disease_dancer=False, is_grass_dancer=False, is_grass_walker=False, is_grass_glider=False, is_grass_dweller=False, is_space_walker=False, is_space_glider=False, is_space_dancer=False, is_symbiotic=False, is_hive_mind=False, is_shelter_strider=False, is_sand_strider=False, is_ash_strider=False, is_snow_strider=False, is_ice_strider=False, is_lava_strider=False, is_forest_strider=False, is_grass_strider=False, is_wall_strider=False, is_web_strider=False, is_mountain_strider=False, is_cave_strider=False, is_deep_water_strider=False, is_space_strider=False, is_marsh_glider=False, is_storm_strider=False, is_blizzard_strider=False, is_earthquake_strider=False, is_volcanic_strider=False, is_rain_strider=False, is_fire_strider=False, is_quicksand_glider=False, is_quicksand_walker=False, is_quicksand_dweller=False, is_quicksand_dancer=False, is_quicksand_strider=False, is_mud_strider=False, is_marsh_dancer=False, is_day_strider=False, is_night_strider=False, is_marsh_dweller=False, is_marsh_walker=False, is_spring_strider=False, is_summer_strider=False, is_autumn_strider=False, is_winter_strider=False, is_disease_strider=False, is_poison_strider=False, is_parasite_strider=False, is_stun_strider=False):
        ...
        self.is_night_dweller = is_night_dweller
        self.is_spring_dweller = is_spring_dweller
        self.is_summer_dweller = is_summer_dweller
        self.is_autumn_dweller = is_autumn_dweller
        self.is_winter_dweller = is_winter_dweller
        self.is_drought_dweller = is_drought_dweller
        self.is_earthquake_dweller = is_earthquake_dweller
        self.is_volcanic_dweller = is_volcanic_dweller
        self.is_fire_dweller = is_fire_dweller
        self.is_rain_dweller = is_rain_dweller
        self.is_disease_dweller = is_disease_dweller
        self.is_poison_dweller = is_poison_dweller
        self.is_venom_resistant = is_venom_resistant
        self.is_ageless = is_ageless
        self.is_disease_resistant = is_disease_resistant
        self.is_parasite_dweller = is_parasite_dweller
        self.is_stun_dweller = is_stun_dweller
        self.is_sleep_dweller = is_sleep_dweller
        self.is_snow_walker = is_snow_walker
        self.is_ice_walker = is_ice_walker
        self.is_lava_walker = is_lava_walker
        self.is_lava_glider = is_lava_glider
        self.is_lava_dweller = is_lava_dweller
        self.is_space_dweller = is_space_dweller
        self.is_shelter_dweller = is_shelter_dweller
        self.is_shelter_dweller = is_shelter_dweller
        self.is_shelter_dweller = is_shelter_dweller
        self.is_shelter_dweller = is_shelter_dweller
        self.is_shelter_dweller = is_shelter_dweller
        self.is_night_walker = is_night_walker
        self.is_deep_water_walker = is_deep_water_walker
        self.is_wall_walker = is_wall_walker
        self.is_day_walker = is_day_walker
        self.is_spring_walker = is_spring_walker
        self.is_summer_walker = is_summer_walker
        self.is_autumn_walker = is_autumn_walker
        self.is_winter_walker = is_winter_walker
        self.is_shelter_walker = is_shelter_walker
        self.is_drought_glider = is_drought_glider
        self.is_blizzard_walker = is_blizzard_walker
        self.is_storm_walker = is_storm_walker
        self.is_rain_walker = is_rain_walker
        self.is_volcanic_walker = is_volcanic_walker
        self.is_earthquake_walker = is_earthquake_walker
        self.is_fire_walker = is_fire_walker
        self.is_drought_walker = is_drought_walker
        self.is_mud_walker = is_mud_walker
        self.is_sand_walker = is_sand_walker
        self.is_water_walker = is_water_walker
        self.is_storm_glider = is_storm_glider
        self.is_storm_glider = is_storm_glider
        self.is_fire_glider = is_fire_glider
        self.is_web_glider = is_web_glider
        self.is_forest_glider = is_forest_glider
        self.is_shelter_glider = is_shelter_glider
        self.is_mountain_walker = is_mountain_walker
        self.is_mountain_glider = is_mountain_glider
        self.is_mountain_dweller = is_mountain_dweller
        self.is_sand_dweller = is_sand_dweller
        self.is_forest_dweller = is_forest_dweller
        self.is_water_dweller = is_water_dweller
        self.is_ice_dweller = is_ice_dweller
        self.is_ash_dweller = is_ash_dweller
        self.is_snow_dweller = is_snow_dweller
        self.is_water_glider = is_water_glider
        ...
        self.is_hypnotic = is_hypnotic
        self.is_tracker = is_tracker
        self.is_empathic = is_empathic
        self.is_contagious = is_contagious
        self.is_arboreal = is_arboreal
        self.is_stargazer = is_stargazer
        self.is_sure_footed = is_sure_footed
        self.is_dust_bather = is_dust_bather
        self.is_magnetic = is_magnetic
        self.is_drought_resistant = is_drought_resistant
        self.is_moon_bather = is_moon_bather
        ...
        self.is_storm_chaser = is_storm_chaser
        self.is_shadow_stalker = is_shadow_stalker
        self.is_pyrophilic = is_pyrophilic
        self.is_desperate = is_desperate
        self.is_iron_willed = is_iron_willed
        self.is_frost_walker = is_frost_walker
        ...
        self.is_marsh_glider = is_marsh_glider
        ...
        self.is_rain_strider = is_rain_strider
        self.is_fire_strider = is_fire_strider
        self.is_quicksand_glider = is_quicksand_glider
        self.is_quicksand_walker = is_quicksand_walker
        self.is_quicksand_dweller = is_quicksand_dweller
        self.is_quicksand_dancer = is_quicksand_dancer
        self.is_quicksand_strider = is_quicksand_strider
        self.is_mud_strider = is_mud_strider
        self.is_marsh_dancer = is_marsh_dancer
        self.is_day_strider = is_day_strider
        self.is_night_strider = is_night_strider
        self.is_marsh_dweller = is_marsh_dweller
        self.is_marsh_walker = is_marsh_walker
        self.is_disease_strider = is_disease_strider
        self.is_poison_strider = is_poison_strider
        self.is_parasite_strider = is_parasite_strider
        self.is_stun_strider = is_stun_strider
        self.is_spring_strider = is_spring_strider
        self.is_summer_strider = is_summer_strider
        self.is_autumn_strider = is_autumn_strider
        self.is_winter_strider = is_winter_strider
        ...
        self.is_forest_walker = is_forest_walker
        self.is_rain_dancer = is_rain_dancer
        self.is_fire_dancer = is_fire_dancer
        self.is_snow_dancer = is_snow_dancer
        self.is_storm_dancer = is_storm_dancer
        self.is_blizzard_dancer = is_blizzard_dancer
        self.is_earthquake_dancer = is_earthquake_dancer
        self.is_volcanic_dancer = is_volcanic_dancer
        self.is_drought_dancer = is_drought_dancer
        self.is_spring_dancer = is_spring_dancer
        self.is_summer_dancer = is_summer_dancer
        self.is_autumn_dancer = is_autumn_dancer
        self.is_winter_dancer = is_winter_dancer
        self.is_day_dancer = is_day_dancer
        self.is_night_dancer = is_night_dancer
        self.is_moon_dancer = is_moon_dancer
        self.is_weather_sensitive = is_weather_sensitive
        self.is_sand_dancer = is_sand_dancer
        self.is_cave_dancer = is_cave_dancer
        self.is_water_dancer = is_water_dancer
        self.is_forest_dancer = is_forest_dancer
        self.is_ash_dancer = is_ash_dancer
        self.is_mud_dancer = is_mud_dancer
        self.is_ice_dancer = is_ice_dancer
        self.is_mountain_dancer = is_mountain_dancer
        self.is_deep_water_dancer = is_deep_water_dancer
        self.is_lava_dancer = is_lava_dancer
        self.is_space_walker = is_space_walker
        self.is_space_glider = is_space_glider
        self.is_space_dancer = is_space_dancer
        self.is_symbiotic = is_symbiotic
        self.is_hive_mind = is_hive_mind
        self.is_shelter_strider = is_shelter_strider

        self.is_wall_dancer = is_wall_dancer
        self.is_web_dancer = is_web_dancer
        self.is_shelter_dancer = is_shelter_dancer
        self.is_wind_dancer = is_wind_dancer
        self.is_stun_dancer = is_stun_dancer
        self.is_poison_dancer = is_poison_dancer
        self.is_parasite_dancer = is_parasite_dancer
        self.is_sleep_dancer = is_sleep_dancer
        self.is_disease_dancer = is_disease_dancer
        self.is_grass_dancer = is_grass_dancer
        self.is_grass_walker = is_grass_walker
        self.is_grass_glider = is_grass_glider
        self.is_grass_dweller = is_grass_dweller
        self.is_wall_dancer = is_wall_dancer
        self.is_fire_dancer = is_fire_dancer
        self.is_blizzard_glider = is_blizzard_glider
        self.is_seismic_sensitive = is_seismic_sensitive
        self.is_mud_glider = is_mud_glider
        self.is_drought_strider = is_drought_strider
        self.is_earthquake_glider = is_earthquake_glider
        self.is_volcanic_glider = is_volcanic_glider
        self.is_ice_glider = is_ice_glider
        self.is_day_glider = is_day_glider
        self.is_night_glider = is_night_glider
        self.is_snow_glider = is_snow_glider
        self.is_deep_water_glider = is_deep_water_glider
        self.is_ash_glider = is_ash_glider
        self.is_spring_glider = is_spring_glider
        self.is_summer_glider = is_summer_glider
        self.is_autumn_glider = is_autumn_glider
        self.is_winter_glider = is_winter_glider
        self.is_wall_glider = is_wall_glider
        self.is_rain_glider = is_rain_glider
        self.is_sand_glider = is_sand_glider
...
class Universe:
    ...
    def move_entity(self, entity, dx, dy):
        ...
        if hasattr(entity, 'stamina'):
            ...
            if not getattr(entity, 'is_flying', False):
                if elevation_diff > 0:
                    if not getattr(entity, 'is_agile', False) and not getattr(entity, 'is_mountain_walker', False) and not (getattr(entity, 'is_cave_walker', False) and any(t.terrain_type == 'cave' for t in terrains_here)) and not (getattr(entity, 'is_snow_walker', False) and any(t.terrain_type == 'snow' for t in terrains_here)) and not (getattr(entity, 'is_ice_walker', False) and any(t.terrain_type == 'ice' for t in terrains_here)) and not (getattr(entity, 'is_lava_walker', False) and any(t.terrain_type == 'lava' for t in terrains_here)) and not (getattr(entity, 'is_blizzard_walker', False) and self.current_event == 'blizzard') and not (getattr(entity, 'is_storm_walker', False) and self.current_event == 'storm') and not (getattr(entity, 'is_rain_walker', False) and self.current_event == 'rain') and not (getattr(entity, 'is_volcanic_walker', False) and self.current_event == 'volcano') and not (getattr(entity, "is_earthquake_walker", False) and self.current_event == "earthquake") and not (getattr(entity, "is_fire_walker", False) and any(e.event_type == "fire" and (new_x - e.x)**2 + (new_y - e.y)**2 <= e.radius**2 for e in self.localized_events)) and not (getattr(entity, "is_drought_walker", False) and self.current_event == "drought") and not (getattr(entity, "is_mud_walker", False) and any(t.terrain_type == "mud" for t in terrains_here)) and not (getattr(entity, "is_sand_walker", False) and any(t.terrain_type == "sand" for t in terrains_here)) and not (getattr(entity, "is_grass_walker", False) and any(t.terrain_type == "grass" for t in terrains_here)) and not (getattr(entity, "is_water_walker", False) and any(t.terrain_type == "water" for t in terrains_here)) and not (getattr(entity, "is_marsh_walker", False) and any(t.terrain_type in ["mud", "water"] for t in terrains_here)) and not (getattr(entity, "is_night_walker", False) and self.is_night) and not (getattr(entity, "is_deep_water_walker", False) and any(t.terrain_type == "deep-water" for t in terrains_here)) and not (getattr(entity, "is_wall_walker", False) and any(t.terrain_type == "wall" for t in terrains_here)) and not (getattr(entity, "is_day_walker", False) and self.is_day) and not (getattr(entity, "is_spring_walker", False) and self.current_season == 'spring') and not (getattr(entity, "is_summer_walker", False) and self.current_season == 'summer') and not (getattr(entity, "is_autumn_walker", False) and self.current_season == 'autumn') and not (getattr(entity, "is_winter_walker", False) and self.current_season == 'winter') and not (getattr(entity, "is_shelter_walker", False) and ((getattr(entity, 'is_blizzard_dweller', False) and self.current_event == 'blizzard') or (getattr(entity, 'is_drought_dweller', False) and self.current_event == 'drought') or (getattr(entity, 'is_earthquake_dweller', False) and self.current_event == 'earthquake') or (getattr(entity, 'is_volcanic_dweller', False) and self.current_event == 'volcano') or (getattr(entity, 'is_fire_dweller', False) and any(e.event_type == 'fire' and (new_x - e.x)**2 + (new_y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_rain_dweller', False) and any(e.event_type == 'rain' and (new_x - e.x)**2 + (new_y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_storm_dweller', False) and self.current_event == 'storm') or any(t.terrain_type == 'shelter' for t in terrains_here))) and not (getattr(entity, "is_space_walker", False) and any(t.terrain_type == "space" for t in terrains_here)) and not (getattr(entity, "is_quicksand_walker", False) and any(q.x == new_x and q.y == new_y for q in self.quicksands)):
                        stamina_cost += elevation_diff
                elif elevation_diff < -1:
                    if getattr(entity, 'is_space_glider', False) and any(t.terrain_type == 'space' for t in terrains_here):
                        pass # Space gliders float down gently
                    else:
            ...
            if getattr(entity, 'is_lightweight', False):
                stamina_cost = max(0, stamina_cost - 1)
            if getattr(entity, 'is_shadow_stalker', False) and self.is_night:
                stamina_cost = 0
            if getattr(entity, 'is_disease_strider', False) and getattr(entity, 'is_infected', False):
                stamina_cost = 0
            if getattr(entity, 'is_day_strider', False) and self.is_day:
                stamina_cost = 0
            if getattr(entity, 'is_night_strider', False) and self.is_night:
                stamina_cost = 0
            if getattr(entity, 'is_spring_strider', False) and self.current_season == 'spring':
                stamina_cost = 0
            if getattr(entity, 'is_summer_strider', False) and self.current_season == 'summer':
                stamina_cost = 0
            if getattr(entity, 'is_autumn_strider', False) and self.current_season == 'autumn':
                stamina_cost = 0
            if getattr(entity, 'is_winter_strider', False) and self.current_season == 'winter':
                stamina_cost = 0
            if getattr(entity, 'is_mountain_glider', False) and any(t.terrain_type == 'mountain' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_frost_walker', False) and any(t.terrain_type in ['snow', 'ice'] for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_marsh_strider', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_mud_glider', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_marsh_glider', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_disease_strider', False) and getattr(entity, 'is_infected', False):
                stamina_cost = 0
            if getattr(entity, 'is_poison_strider', False) and getattr(entity, 'poisoned_time', 0) > 0:
                stamina_cost = 0
            if getattr(entity, 'is_parasite_strider', False) and len(getattr(entity, 'attached_parasites', [])) > 0:
                stamina_cost = 0
            if getattr(entity, 'is_stun_strider', False) and getattr(entity, 'stunned_time', 0) > 0:
                stamina_cost = 0
            if getattr(entity, 'is_drought_strider', False) and self.current_event == 'drought':
                stamina_cost = 0
            if getattr(entity, 'is_rain_strider', False) and any(e.event_type == 'rain' and (new_x - e.x)**2 + (new_y - e.y)**2 <= e.radius**2 for e in self.localized_events):
                stamina_cost = 0
            if getattr(entity, 'is_fire_strider', False) and any(e.event_type == 'fire' and (new_x - e.x)**2 + (new_y - e.y)**2 <= e.radius**2 for e in self.localized_events):
                stamina_cost = 0
            if getattr(entity, 'is_drought_glider', False) and self.current_event == 'drought':
                stamina_cost = 0
            if getattr(entity, 'is_lava_glider', False) and any(t.terrain_type == 'lava' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_earthquake_glider', False) and self.current_event == 'earthquake':
                stamina_cost = 0
            if getattr(entity, 'is_volcanic_glider', False) and self.current_event == 'volcano':
                stamina_cost = 0
            if getattr(entity, 'is_ice_glider', False) and any(t.terrain_type == 'ice' for t in terrains_here):
                stamina_cost = 0
            ...
            if getattr(entity, 'is_space_glider', False) and any(t.terrain_type == 'space' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_ash_glider', False) and any(t.terrain_type == 'ash' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_day_glider', False) and self.is_day:
                stamina_cost = 0
            if getattr(entity, "is_night_glider", False) and self.is_night:
                stamina_cost = 0
            if getattr(entity, 'is_sand_glider', False) and any(t.terrain_type == 'sand' for t in terrains_here):
                stamina_cost = 0
            ...
            if getattr(entity, 'is_ash_strider', False) and any(t.terrain_type == 'ash' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_mud_strider', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                stamina_cost = 0
            ...
            if getattr(entity, 'is_ash_walker', False) and any(t.terrain_type == 'ash' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_wind_glider', False) and self.current_event == 'storm':
                stamina_cost = 0
            if getattr(entity, 'is_forest_walker', False) and any(t.terrain_type == 'forest' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_grass_glider', False) and any(t.terrain_type == 'grass' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_forest_glider', False) and any(t.terrain_type == 'forest' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_water_glider', False) and any(t.terrain_type == 'water' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_shelter_glider', False) and ((getattr(entity, 'is_blizzard_dweller', False) and self.current_event == 'blizzard') or (getattr(entity, 'is_drought_dweller', False) and self.current_event == 'drought') or (getattr(entity, 'is_earthquake_dweller', False) and self.current_event == 'earthquake') or (getattr(entity, 'is_volcanic_dweller', False) and self.current_event == 'volcano') or (getattr(entity, 'is_fire_dweller', False) and any(e.event_type == 'fire' and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_rain_dweller', False) and any(e.event_type == 'rain' and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_storm_dweller', False) and self.current_event == 'storm') or any(t.terrain_type == 'shelter' for t in terrains_here)):
                stamina_cost = 0
            if getattr(entity, 'is_blizzard_glider', False) and self.current_event == 'blizzard':
                stamina_cost = 0
            if getattr(entity, 'is_storm_glider', False) and self.current_event == 'storm':
                stamina_cost = 0
            if getattr(entity, 'is_spring_glider', False) and self.current_season == 'spring':
                stamina_cost = 0
            if getattr(entity, 'is_summer_glider', False) and self.current_season == 'summer':
                stamina_cost = 0
            if getattr(entity, 'is_autumn_glider', False) and self.current_season == 'autumn':
                stamina_cost = 0
            if getattr(entity, 'is_winter_glider', False) and self.current_season == 'winter':
                stamina_cost = 0
            if getattr(entity, 'is_wall_glider', False) and any(t.terrain_type == 'wall' for t in terrains_here):
                stamina_cost = 0
            if getattr(entity, 'is_cave_glider', False) and any(t.terrain_type == 'cave' for t in terrains_here):
                stamina_cost = 0
            in_rain_event = any(event.event_type == 'rain' and (new_x - event.x)**2 + (new_y - event.y)**2 <= event.radius**2 for event in self.localized_events)
            if getattr(entity, 'is_rain_glider', False) and in_rain_event:
                stamina_cost = 0

            in_fire_event = any(event.event_type == 'fire' and (new_x - event.x)**2 + (new_y - event.y)**2 <= event.radius**2 for event in self.localized_events)
            if getattr(entity, 'is_fire_glider', False) and in_fire_event:
                stamina_cost = 0
            ...
            if any(q.x == new_x and q.y == new_y for q in self.quicksands):
                if getattr(entity, 'is_quicksand_glider', False):
                    stamina_cost = 0
    ...
    def tick(self):
        ...
        if random.random() < self.disease_chance and self.entities:
            valid_targets = [e for e in self.entities if not getattr(e, 'is_immune', False) and not getattr(e, 'is_disease_resistant', False)]
            if valid_targets:
        ...
        if self.is_day:
            for entity in self.entities:
                if getattr(entity, 'is_day_dancer', False):
        ...
        if self.is_night:
            for entity in self.entities:
                if getattr(entity, 'is_night_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
                if getattr(entity, 'is_moon_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
        ...
        if current_season == 'spring':
            for entity in self.entities:
                if getattr(entity, 'is_spring_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
            self.base_temperature = 20
        elif current_season == 'summer':
            for entity in self.entities:
                if getattr(entity, 'is_summer_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
            self.base_temperature = 30
        elif current_season == 'autumn':
            for entity in self.entities:
                if getattr(entity, 'is_autumn_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
            self.base_temperature = 10
        elif current_season == 'winter':
            for entity in self.entities:
                if getattr(entity, 'is_winter_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
        ...
        if self.current_event == 'blizzard':
            self.base_temperature -= 20
            for entity in self.entities:
                if getattr(entity, 'is_blizzard_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
        elif self.current_event == 'sandstorm':
            for entity in self.entities:
                if getattr(entity, 'is_sand_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
            # Create sand patches
            for _ in range(10):
                ...
                terrains = self.get_terrains_at(hx, hy)
                for t in terrains:
                    if t.terrain_type in ['grass', 'mud', 'ash']:
                        t.terrain_type = 'sand'
                        break
        ...
        if self.current_event:
            ...
            if current_season == 'spring' or current_season == 'autumn':
                event_choices = ['storm', 'earthquake', 'volcano', 'sandstorm']
            elif current_season == 'summer':
                event_choices = ['storm', 'drought', 'earthquake', 'volcano', 'sandstorm']
            else: # winter
                event_choices = ['blizzard', 'earthquake', 'volcano', 'sandstorm']
        ...
        for event in self.localized_events[:]:
            ...
            if event.event_type == 'rain':
                for entity in self.entities:
                    if getattr(entity, 'is_rain_dancer', False):
                    ...
                    for fy in range(max(0, event.y - event.radius), min(self.height, event.y + event.radius + 1)):
                        if (fx - event.x)**2 + (fy - event.y)**2 <= event.radius**2:
                            ...
                            for e in entities_here:
                                if getattr(e, 'is_volcanic', False) or getattr(e, 'is_fire_dweller', False) or getattr(e, 'is_fire_dancer', False):
                                    if getattr(e, 'is_fire_dancer', False):
                                        max_energy = int(e.max_energy * 1.5) if getattr(e, "is_gluttonous", False) else e.max_energy
                                        e.energy = min(max_energy, e.energy + 5)
                                    continue
                                e.energy = 0
        ...
        if self.current_event == 'volcano':
            for entity in self.entities:
                if getattr(entity, 'is_volcanic_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)

        if self.current_event == 'drought':
            for entity in self.entities:
                if getattr(entity, 'is_drought_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
            for _ in range(10):
                hx = random.randint(0, self.width - 1)
            ...
            for entity in self.entities:
                if getattr(entity, 'is_wind_dancer', False):
                    energy_gain = 5
                    entity.energy = min(entity.max_energy, entity.energy + energy_gain)

                if getattr(entity, 'is_storm_dancer', False):
                    max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                    entity.energy = min(max_energy, entity.energy + 5)
                if getattr(entity, 'is_sand_dancer', False):
                    if any(t.terrain_type == 'sand' for t in self.get_terrains_at(entity.x, entity.y)):
                        max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                        entity.energy = min(max_energy, entity.energy + 5)
            for _ in range(10):
                hx = random.randint(0, self.width - 1)
        ...
        for entity in self.entities:
            ...
            in_shelter = (getattr(entity, 'is_disease_dweller', False) and getattr(entity, 'is_infected', False) or (getattr(entity, 'is_marsh_dweller', False) and any(t.terrain_type in ('mud', 'water') for t in terrains_here))) or (getattr(entity, 'is_poison_dweller', False) and getattr(entity, 'poisoned_time', 0) > 0) or (getattr(entity, 'is_stun_dweller', False) and getattr(entity, 'stunned_time', 0) > 0) or (getattr(entity, 'is_sleep_dweller', False) and getattr(entity, 'is_sleeping', False)) or (getattr(entity, 'is_blizzard_dweller', False) and self.current_event == 'blizzard') or (getattr(entity, 'is_drought_dweller', False) and self.current_event == 'drought') or (getattr(entity, 'is_earthquake_dweller', False) and self.current_event == 'earthquake') or (getattr(entity, 'is_volcanic_dweller', False) and self.current_event == 'volcano') or (getattr(entity, 'is_fire_dweller', False) and any(e.event_type == 'fire' and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_rain_dweller', False) and any(e.event_type == 'rain' and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(entity, 'is_day_dweller', False) and self.is_day) or (getattr(entity, 'is_night_dweller', False) and self.is_night) or (getattr(entity, 'is_spring_dweller', False) and self.current_season == 'spring') or (getattr(entity, 'is_summer_dweller', False) and self.current_season == 'summer') or (getattr(entity, 'is_autumn_dweller', False) and self.current_season == 'autumn') or (getattr(entity, 'is_winter_dweller', False) and self.current_season == 'winter') or (getattr(entity, 'is_storm_dweller', False) and self.current_event == 'storm') or any(t.terrain_type == 'shelter' for t in terrains_here) or (getattr(entity, 'can_burrow', False) and entity.is_sleeping) or (getattr(entity, 'is_arboreal', False) and any(t.terrain_type == 'forest' for t in terrains_here)) or (getattr(entity, 'is_mountain_dweller', False) and any(t.terrain_type in ('mountain', 'cave') for t in terrains_here)) or (getattr(entity, 'is_sand_dweller', False) and any(t.terrain_type == 'sand' for t in terrains_here)) or (getattr(entity, 'is_grass_dweller', False) and any(t.terrain_type == 'grass' for t in terrains_here)) or (getattr(entity, 'is_forest_dweller', False) and any(t.terrain_type == 'forest' for t in terrains_here)) or (getattr(entity, 'is_water_dweller', False) and any(t.terrain_type == 'water' for t in terrains_here)) or (getattr(entity, 'is_ice_dweller', False) and any(t.terrain_type == 'ice' for t in terrains_here)) or (getattr(entity, 'is_ash_dweller', False) and any(t.terrain_type == 'ash' for t in terrains_here)) or (getattr(entity, 'is_snow_dweller', False) and any(t.terrain_type == 'snow' for t in terrains_here)) or (getattr(entity, 'is_mud_dweller', False) and any(t.terrain_type == 'mud' for t in terrains_here)) or (getattr(entity, 'is_web_dweller', False) and any(t.terrain_type == 'web' for t in terrains_here)) or (getattr(entity, 'is_web_dweller', False) and any(t.terrain_type == 'web' for t in terrains_here)) or (getattr(entity, 'is_deep_water_dweller', False) and any(t.terrain_type == 'deep-water' for t in terrains_here)) or (getattr(entity, 'is_cave_dweller', False) and any(t.terrain_type == 'cave' for t in terrains_here)) or (getattr(entity, 'is_wall_dweller', False) and any(t.terrain_type == 'wall' for t in terrains_here)) or (getattr(entity, 'is_lava_dweller', False) and any(t.terrain_type == 'lava' for t in terrains_here)) or (getattr(entity, 'is_space_dweller', False) and any(t.terrain_type == 'space' for t in terrains_here)) or (getattr(entity, 'is_parasite_dweller', False) and len(getattr(entity, 'attached_parasites', [])) > 0) or (getattr(entity, 'is_shelter_dweller', False) and any(t.terrain_type == 'shelter' for t in terrains_here)) or (getattr(entity, 'is_quicksand_dweller', False) and any(q.x == entity.x and q.y == entity.y for q in self.quicksands))
            if getattr(entity, 'is_earthquake_dancer', False) and self.current_event == 'earthquake':
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if self.current_event == 'earthquake' and not getattr(entity, 'is_sure_footed', False):
            ...
            if getattr(entity, 'is_weather_sensitive', False) and (self.current_event in ['storm', 'blizzard'] or any(e.event_type in ['rain', 'snow'] and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)):
                entity.stamina = min(getattr(entity, 'max_stamina', 50), getattr(entity, 'stamina', 50) + 5)

            if getattr(entity, 'is_magnetic', False) and self.current_event == 'storm':
                entity.energy = min(getattr(entity, 'max_energy', entity.size * 50), entity.energy + 5)
                entity.stamina = min(getattr(entity, 'max_stamina', 50), getattr(entity, 'stamina', 50) + 10)
            if getattr(entity, 'is_stargazer', False) and self.is_night and not self.current_event:
                entity.energy = min(getattr(entity, 'max_energy', entity.size * 50), entity.energy + 1)
                entity.stamina = min(getattr(entity, 'max_stamina', 50), getattr(entity, 'stamina', 50) + 2)

            if getattr(entity, 'is_moon_bather', False) and self.is_night:
                terrains_here = self.get_terrains_at(entity.x, entity.y)
                if not any(t.terrain_type in ['shelter', 'ash'] for t in terrains_here):
                    entity.energy = min(getattr(entity, 'max_energy', entity.size * 50), entity.energy + 2)
                    entity.stamina = min(getattr(entity, 'max_stamina', 50), getattr(entity, 'stamina', 50) + 5)
            ...
            if getattr(entity, 'is_symbiotic', False) and getattr(entity, 'symbiotic_with', None) is not None and entity.energy > 20:
                for e in self.entities:
                    if e != entity and e.is_alive and e.species == entity.symbiotic_with:
                        dist = abs(e.x - entity.x) + abs(e.y - entity.y)
                        if dist <= 1:
                            transfer = 2
                            entity.energy -= transfer
            ...
            if getattr(entity, 'is_hive_mind', False) and entity.energy < entity.max_energy * 0.2:
                # Seek energy from nearby healthy hive members
                for e in self.entities:
                    if e != entity and e.is_alive and e.species == entity.species and getattr(e, 'is_hive_mind', False) and e.energy > e.max_energy * 0.5:
                        dist = abs(e.x - entity.x) + abs(e.y - entity.y)
                        if dist <= getattr(e, 'perception_radius', 10):
                            transfer = 5
                            e.energy -= transfer
                            entity.energy += transfer
                            break
            ...
            if getattr(entity, 'is_hibernating', False):
                ...
                if self.current_event == 'storm':
                    if getattr(entity, 'is_storm_dancer', False) or getattr(entity, 'is_wind_dancer', False):
                        energy_loss = entity.size
                    elif (getattr(entity, 'is_mountain_dweller', False) and any(t.terrain_type == 'cave' for t in terrains_here)) or getattr(entity, 'is_storm_dweller', False):
                        energy_loss = entity.size
                    else:
                    ...
                    if getattr(entity, 'is_blizzard_dancer', False):
                        energy_loss = entity.size # handled gain separately, but avoid high loss
                    elif getattr(entity, 'is_arctic', False):
                        energy_loss = 0
                    else:
                    ...
                    if getattr(entity, 'is_volcanic_dancer', False):
                        energy_loss = entity.size
                elif self.current_event == 'drought':
                    if getattr(entity, 'is_drought_dancer', False):
                        energy_loss = entity.size
                ...
                if current_temp > getattr(entity, 'preferred_temperature', 20) + getattr(entity, 'temperature_tolerance', 40) and getattr(entity, 'is_photosensitive', False) and self.is_day:
                    hydration_loss += 1
                if not (getattr(entity, 'is_drought_resistant', False) and self.current_event == 'drought'):
                ...
                if in_shelter:
                    energy_loss -= 2
                if getattr(entity, 'is_quicksand_dweller', False) and any(q.x == entity.x and q.y == entity.y for q in self.quicksands):
                    energy_loss -= 2
                if getattr(entity, 'is_marsh_dweller', False) and any(t.terrain_type in ('mud', 'water') for t in terrains_here):
                    energy_loss -= 2
                if getattr(entity, 'is_disease_dweller', False) and getattr(entity, 'is_infected', False):
                    energy_loss -= 20
                if getattr(entity, 'is_parasite_dweller', False) and len(getattr(entity, 'attached_parasites', [])) > 0:
                    energy_loss -= 20
                ...
                if getattr(entity, 'is_volcanic', False) and any(t.terrain_type == 'ash' for t in self.get_terrains_at(entity.x, entity.y)):
                    energy_loss -= 3
                if getattr(entity, 'is_space_dancer', False) and any(t.terrain_type == 'space' for t in self.get_terrains_at(entity.x, entity.y)):
                    energy_loss -= 3
                if getattr(entity, 'is_pyrophilic', False) and any(t.terrain_type == 'ash' for t in self.get_terrains_at(entity.x, entity.y)):
                    entity.energy = min(getattr(entity, 'max_energy', 50), entity.energy + 2)
                    entity.stamina = min(getattr(entity, 'max_stamina', 50), getattr(entity, 'stamina', 50) + 5)
            ...
            cap = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
            entity.energy = min(cap, entity.energy)
            if getattr(entity, 'is_stun_dancer', False) and getattr(entity, 'stunned_time', 0) > 0:
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_poison_dancer', False) and getattr(entity, 'poisoned_time', 0) > 0:
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_parasite_dancer', False) and len(getattr(entity, 'attached_parasites', [])) > 0:
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_sleep_dancer', False) and getattr(entity, 'is_sleeping', False):
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_disease_dancer', False) and getattr(entity, 'is_infected', False):
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_quicksand_dancer', False) and any(q.x == entity.x and q.y == entity.y for q in self.quicksands):
                entity.energy = min(cap, entity.energy + 5)
            if getattr(entity, 'is_grass_dancer', False) and any(t.terrain_type == 'grass' for t in terrains_here):
                entity.energy = min(cap, entity.energy + 5)
            ...
            if getattr(entity, 'is_cave_dancer', False) and any(t.terrain_type == 'cave' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_mountain_dancer', False) and any(t.terrain_type == 'mountain' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_deep_water_dancer', False) and any(t.terrain_type == 'deep-water' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_lava_dancer', False) and any(t.terrain_type == 'lava' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_wall_dancer', False) and any(t.terrain_type == 'wall' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_web_dancer', False) and any(t.terrain_type == 'web' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, 'is_gluttonous', False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_shelter_dancer', False) and any(t.terrain_type == 'shelter' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, 'is_gluttonous', False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_wall_dancer', False) and any(t.terrain_type == 'wall' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_water_dancer', False) and any(t.terrain_type == 'water' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_forest_dancer', False) and any(t.terrain_type == 'forest' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)

            if getattr(entity, 'is_ash_dancer', False) and any(t.terrain_type == 'ash' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)

            if getattr(entity, 'is_mud_dancer', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            if getattr(entity, 'is_marsh_dancer', False) and any(t.terrain_type == 'mud' for t in terrains_here):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)

            if getattr(entity, 'is_ice_dancer', False) and any(t.terrain_type == 'ice' for t in self.get_terrains_at(entity.x, entity.y)):
                max_energy = int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy
                entity.energy = min(max_energy, entity.energy + 5)
            ...
            if entity.is_alive:
                ...
                if not entity.is_sleeping and entity.energy >= eff_threshold and (len(self.entities) + len(new_entities) < self.population_limit) and random.random() < reproduction_chance:
                    ...
                    child_is_contagious = getattr(entity, 'is_contagious', False)
                    child_is_arboreal = getattr(entity, 'is_arboreal', False)
                    child_is_stargazer = getattr(entity, 'is_stargazer', False)
                    child_is_sure_footed = getattr(entity, 'is_sure_footed', False)
                    child_is_magnetic = getattr(entity, 'is_magnetic', False)
                    child_is_drought_resistant = getattr(entity, 'is_drought_resistant', False)
                    child_is_moon_bather = getattr(entity, 'is_moon_bather', False)
                    child_is_storm_chaser = getattr(entity, 'is_storm_chaser', False)
                    child_is_shadow_stalker = getattr(entity, 'is_shadow_stalker', False)
                    child_is_pyrophilic = getattr(entity, 'is_pyrophilic', False)
                    child_is_desperate = getattr(entity, 'is_desperate', False)
                    child_is_iron_willed = getattr(entity, 'is_iron_willed', False)
                    child_is_frost_walker = getattr(entity, 'is_frost_walker', False)
                    child_is_marsh_strider = getattr(entity, 'is_marsh_strider', False)
                    child_is_day_strider = getattr(entity, 'is_day_strider', False)
                    child_is_night_strider = getattr(entity, 'is_night_strider', False)
                    child_is_spring_strider = getattr(entity, 'is_spring_strider', False)
                    child_is_disease_strider = getattr(entity, 'is_disease_strider', False)
                    child_is_poison_strider = getattr(entity, 'is_poison_strider', False)
                    child_is_parasite_strider = getattr(entity, 'is_parasite_strider', False)
                    child_is_stun_strider = getattr(entity, 'is_stun_strider', False)
                    child_is_summer_strider = getattr(entity, 'is_summer_strider', False)
                    child_is_autumn_strider = getattr(entity, 'is_autumn_strider', False)
                    child_is_winter_strider = getattr(entity, 'is_winter_strider', False)
                    ...
                    child_is_marsh_glider = getattr(entity, 'is_marsh_glider', False)
                    child_is_storm_strider = getattr(entity, 'is_storm_strider', False)
                    ...
                    child_is_earthquake_strider = getattr(entity, 'is_earthquake_strider', False)
                    child_is_volcanic_strider = getattr(entity, 'is_volcanic_strider', False)
                    child_is_rain_strider = getattr(entity, 'is_rain_strider', False)
                    child_is_fire_strider = getattr(entity, 'is_fire_strider', False)
                    child_is_quicksand_glider = getattr(entity, 'is_quicksand_glider', False)
                    child_is_quicksand_walker = getattr(entity, 'is_quicksand_walker', False)
                    child_is_quicksand_dweller = getattr(entity, 'is_quicksand_dweller', False)
                    child_is_marsh_dweller = getattr(entity, 'is_marsh_dweller', False)
                    child_is_marsh_walker = getattr(entity, 'is_marsh_walker', False)
                    child_is_quicksand_dancer = getattr(entity, 'is_quicksand_dancer', False)
                    child_is_quicksand_strider = getattr(entity, 'is_quicksand_strider', False)
                    child_is_mud_strider = getattr(entity, 'is_mud_strider', False)
                    child_is_marsh_dancer = getattr(entity, 'is_marsh_dancer', False)
                    ...
                    child_is_forest_walker = getattr(entity, 'is_forest_walker', False)
                    ...
                    child_is_wind_dancer = getattr(entity, 'is_wind_dancer', False)
                    child_is_stun_dancer = getattr(entity, 'is_stun_dancer', False)
                    child_is_poison_dancer = getattr(entity, 'is_poison_dancer', False)
                    child_is_parasite_dancer = getattr(entity, 'is_parasite_dancer', False)
                    child_is_sleep_dancer = getattr(entity, 'is_sleep_dancer', False)
                    child_is_disease_dancer = getattr(entity, 'is_disease_dancer', False)
                    child_is_grass_dancer = getattr(entity, 'is_grass_dancer', False)
                    child_is_grass_walker = getattr(entity, 'is_grass_walker', False)
                    child_is_grass_glider = getattr(entity, 'is_grass_glider', False)
                    child_is_grass_dweller = getattr(entity, 'is_grass_dweller', False)
                    child_is_storm_dancer = getattr(entity, 'is_storm_dancer', False)
                    child_is_blizzard_dancer = getattr(entity, 'is_blizzard_dancer', False)
                    child_is_earthquake_dancer = getattr(entity, 'is_earthquake_dancer', False)
                    child_is_volcanic_dancer = getattr(entity, 'is_volcanic_dancer', False)
                    child_is_drought_dancer = getattr(entity, 'is_drought_dancer', False)
                    child_is_spring_dancer = getattr(entity, 'is_spring_dancer', False)
                    child_is_day_dancer = getattr(entity, 'is_day_dancer', False)
                    child_is_night_dancer = getattr(entity, 'is_night_dancer', False)
                    child_is_moon_dancer = getattr(entity, 'is_moon_dancer', False)
                    child_is_weather_sensitive = getattr(entity, 'is_weather_sensitive', False)
                    child_is_sand_dancer = getattr(entity, 'is_sand_dancer', False)
                    child_is_cave_dancer = getattr(entity, 'is_cave_dancer', False)
                    child_is_water_dancer = getattr(entity, 'is_water_dancer', False)
                    child_is_forest_dancer = getattr(entity, 'is_forest_dancer', False)
                    child_is_ash_dancer = getattr(entity, 'is_ash_dancer', False)
                    child_is_mud_dancer = getattr(entity, 'is_mud_dancer', False)
                    child_is_ice_dancer = getattr(entity, 'is_ice_dancer', False)
                    child_is_mountain_dancer = getattr(entity, 'is_mountain_dancer', False)
                    child_is_deep_water_dancer = getattr(entity, 'is_deep_water_dancer', False)
                    child_is_lava_dancer = getattr(entity, 'is_lava_dancer', False)
                    child_is_wall_dancer = getattr(entity, 'is_wall_dancer', False)
                    child_is_web_dancer = getattr(entity, 'is_web_dancer', False)
                    child_is_shelter_dancer = getattr(entity, 'is_shelter_dancer', False)
                    child_is_wall_dancer = getattr(entity, 'is_wall_dancer', False)
                    child_is_summer_dancer = getattr(entity, 'is_summer_dancer', False)
                    child_is_autumn_dancer = getattr(entity, 'is_autumn_dancer', False)
                    child_is_winter_dancer = getattr(entity, 'is_winter_dancer', False)
                    ...
                    child_is_mud_glider = getattr(entity, 'is_mud_glider', False)
                    child_is_drought_strider = getattr(entity, 'is_drought_strider', False)
                    child_is_drought_glider = getattr(entity, 'is_drought_glider', False)
                    child_is_earthquake_glider = getattr(entity, 'is_earthquake_glider', False)
                    child_is_volcanic_glider = getattr(entity, 'is_volcanic_glider', False)
                    child_is_ice_glider = getattr(entity, 'is_ice_glider', False)
                    child_is_day_glider = getattr(entity, 'is_day_glider', False)
                    child_is_night_glider = getattr(entity, "is_night_glider", False)
                    child_is_snow_glider = getattr(entity, "is_snow_glider", False)
                    child_is_deep_water_glider = getattr(entity, 'is_deep_water_glider', False)

                    child_is_ash_glider = getattr(entity, 'is_ash_glider', False)
                    child_is_spring_glider = getattr(entity, 'is_spring_glider', False)
                    child_is_summer_glider = getattr(entity, 'is_summer_glider', False)
                    child_is_autumn_glider = getattr(entity, 'is_autumn_glider', False)
                    child_is_winter_glider = getattr(entity, 'is_winter_glider', False)
                    child_is_wall_glider = getattr(entity, 'is_wall_glider', False)
                    child_is_rain_glider = getattr(entity, 'is_rain_glider', False)
                    child_is_sand_glider = getattr(entity, 'is_sand_glider', False)
                    child_is_fire_glider = getattr(entity, 'is_fire_glider', False)
                    child_is_web_glider = getattr(entity, 'is_web_glider', False)
                    child_is_forest_glider = getattr(entity, 'is_forest_glider', False)
                    child_is_water_glider = getattr(entity, 'is_water_glider', False)
                    child_is_shelter_glider = getattr(entity, 'is_shelter_glider', False)
                    child_is_mountain_walker = getattr(entity, 'is_mountain_walker', False)
                    child_is_dust_bather = getattr(entity, 'is_dust_bather', False)
                    ...
                    if random.random() < mutation_chance:
                        child_is_contagious = not child_is_contagious
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_arboreal = not child_is_arboreal
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_stargazer = not child_is_stargazer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sure_footed = not child_is_sure_footed
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_dust_bather = not child_is_dust_bather
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_magnetic = not child_is_magnetic
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_resistant = not child_is_drought_resistant
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_moon_bather = not child_is_moon_bather
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_chaser = not child_is_storm_chaser
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_shadow_stalker = not child_is_shadow_stalker
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_pyrophilic = not child_is_pyrophilic
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_desperate = not child_is_desperate
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_iron_willed = not child_is_iron_willed
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_frost_walker = not child_is_frost_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_marsh_strider = not child_is_marsh_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_disease_strider = not child_is_disease_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_poison_strider = not child_is_poison_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_parasite_strider = not child_is_parasite_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_stun_strider = not child_is_stun_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_day_strider = not child_is_day_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_night_strider = not child_is_night_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_spring_strider = not child_is_spring_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_summer_strider = not child_is_summer_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_autumn_strider = not child_is_autumn_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_winter_strider = not child_is_winter_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_dune_walker = not child_is_dune_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_marsh_glider = not child_is_marsh_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_strider = not child_is_storm_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_rain_strider = not child_is_rain_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_quicksand_walker = not child_is_quicksand_walker
                        mutation_occurred = True
                    if random.random() < 0.1:
                        child_is_quicksand_dweller = not child_is_quicksand_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_marsh_dweller = not child_is_marsh_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_marsh_walker = not child_is_marsh_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_quicksand_dancer = not child_is_quicksand_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_quicksand_strider = not child_is_quicksand_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mud_strider = not child_is_mud_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_marsh_dancer = not child_is_marsh_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        child_is_wind_glider = not child_is_wind_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_forest_walker = not child_is_forest_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_glider = not child_is_storm_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_rain_dancer = not child_is_rain_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_fire_dancer = not child_is_fire_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_snow_dancer = not child_is_snow_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wind_dancer = not child_is_wind_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_stun_dancer = not child_is_stun_dancer
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_poison_dancer = not child_is_poison_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_parasite_dancer = not child_is_parasite_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sleep_dancer = not child_is_sleep_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_disease_dancer = not child_is_disease_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_grass_dancer = not child_is_grass_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_grass_walker = not child_is_grass_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_grass_glider = not child_is_grass_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_grass_dweller = not child_is_grass_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_dancer = not child_is_storm_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_blizzard_dancer = not child_is_blizzard_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_earthquake_dancer = not child_is_earthquake_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_volcanic_dancer = not child_is_volcanic_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_dancer = not child_is_drought_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_spring_dancer = not child_is_spring_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_summer_dancer = not child_is_summer_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_autumn_dancer = not child_is_autumn_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_winter_dancer = not child_is_winter_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_day_dancer = not child_is_day_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_night_dancer = not child_is_night_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_moon_dancer = not child_is_moon_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_weather_sensitive = not child_is_weather_sensitive
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sand_dancer = not child_is_sand_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_cave_dancer = not child_is_cave_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_water_dancer = not child_is_water_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_forest_dancer = not child_is_forest_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ash_dancer = not child_is_ash_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mud_dancer = not child_is_mud_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ice_dancer = not child_is_ice_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mountain_dancer = not child_is_mountain_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_deep_water_dancer = not child_is_deep_water_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_lava_dancer = not child_is_lava_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wall_dancer = not child_is_wall_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_web_dancer = not child_is_web_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_shelter_dancer = not child_is_shelter_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wall_dancer = not child_is_wall_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_blizzard_glider = not child_is_blizzard_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_seismic_sensitive = not child_is_seismic_sensitive
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mud_glider = not child_is_mud_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_strider = not child_is_drought_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_glider = not child_is_drought_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_earthquake_glider = not child_is_earthquake_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_volcanic_glider = not child_is_volcanic_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ice_glider = not child_is_ice_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_day_glider = not child_is_day_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ash_glider = not child_is_ash_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_snow_glider = not child_is_snow_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_spring_glider = not child_is_spring_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_summer_glider = not child_is_summer_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_autumn_glider = not child_is_autumn_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_winter_glider = not child_is_winter_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wall_glider = not child_is_wall_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_rain_glider = not child_is_rain_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sand_glider = not child_is_sand_glider
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_fire_glider = not child_is_fire_glider
                        mutation_occurred = True

                    # Web glider mutation fixed
                    if random.random() < mutation_chance:
                        child_is_web_glider = not child_is_web_glider
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_forest_glider = not child_is_forest_glider
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_water_glider = not child_is_water_glider
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_shelter_glider = not child_is_shelter_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mountain_walker = not child_is_mountain_walker
                        mutation_occurred = True

                    child_is_mountain_glider = getattr(entity, 'is_mountain_glider', False)
                    child_is_mountain_dweller = getattr(entity, 'is_mountain_dweller', False)
                    child_is_sand_dweller = getattr(entity, 'is_sand_dweller', False)
                    child_is_forest_dweller = getattr(entity, 'is_forest_dweller', False)
                    child_is_water_dweller = getattr(entity, 'is_water_dweller', False)
                    child_is_ice_dweller = getattr(entity, 'is_ice_dweller', False)
                    child_is_ash_dweller = getattr(entity, 'is_ash_dweller', False)
                    child_is_snow_dweller = getattr(entity, 'is_snow_dweller', False)
                    child_is_mud_dweller = getattr(entity, 'is_mud_dweller', False)
                    child_is_web_dweller = getattr(entity, 'is_web_dweller', False)
                    child_is_deep_water_dweller = getattr(entity, 'is_deep_water_dweller', False)
                    child_is_lava_dweller = getattr(entity, 'is_lava_dweller', False)
                    child_is_space_dweller = getattr(entity, 'is_space_dweller', False)
                    child_is_shelter_dweller = getattr(entity, 'is_shelter_dweller', False)
                    child_is_space_walker = getattr(entity, 'is_space_walker', False)
                    child_is_space_glider = getattr(entity, 'is_space_glider', False)
                    child_is_space_dancer = getattr(entity, 'is_space_dancer', False)
                    child_is_symbiotic = getattr(entity, 'is_symbiotic', False)
                    child_is_hive_mind = getattr(entity, 'is_hive_mind', False)
                    child_is_shelter_strider = getattr(entity, 'is_shelter_strider', False)
                    child_is_shelter_dweller = getattr(entity, 'is_shelter_dweller', False)
                    child_is_shelter_dweller = getattr(entity, 'is_shelter_dweller', False)
                    child_is_shelter_dweller = getattr(entity, 'is_shelter_dweller', False)
                    child_is_shelter_dweller = getattr(entity, 'is_shelter_dweller', False)
                    child_is_cave_dweller = getattr(entity, 'is_cave_dweller', False)
                    child_is_wall_dweller = getattr(entity, 'is_wall_dweller', False)
                    child_is_cave_glider = getattr(entity, 'is_cave_glider', False)
                    child_is_cave_walker = getattr(entity, 'is_cave_walker', False)
                    child_is_blizzard_dweller = getattr(entity, 'is_blizzard_dweller', False)
                    child_is_storm_dweller = getattr(entity, "is_storm_dweller", False)
                    child_is_day_dweller = getattr(entity, 'is_day_dweller', False)
                    child_is_night_dweller = getattr(entity, 'is_night_dweller', False)
                    child_is_spring_dweller = getattr(entity, 'is_spring_dweller', False)
                    child_is_summer_dweller = getattr(entity, 'is_summer_dweller', False)
                    child_is_autumn_dweller = getattr(entity, 'is_autumn_dweller', False)
                    child_is_winter_dweller = getattr(entity, 'is_winter_dweller', False)
                    child_is_drought_dweller = getattr(entity, 'is_drought_dweller', False)
                    child_is_earthquake_dweller = getattr(entity, 'is_earthquake_dweller', False)
                    child_is_volcanic_dweller = getattr(entity, 'is_volcanic_dweller', False)
                    child_is_fire_dweller = getattr(entity, 'is_fire_dweller', False)
                    child_is_rain_dweller = getattr(entity, 'is_rain_dweller', False)
                    child_is_disease_dweller = getattr(entity, 'is_disease_dweller', False)
                    child_is_poison_dweller = getattr(entity, 'is_poison_dweller', False)
                    child_is_venom_resistant = getattr(entity, 'is_venom_resistant', False)
                    child_is_ageless = getattr(entity, 'is_ageless', False)
                    child_is_disease_resistant = getattr(entity, 'is_disease_resistant', False)
                    child_is_parasite_dweller = getattr(entity, 'is_parasite_dweller', False)
                    ...
                    child_is_snow_walker = getattr(entity, 'is_snow_walker', False)
                    child_is_ice_walker = getattr(entity, 'is_ice_walker', False)
                    child_is_lava_walker = getattr(entity, 'is_lava_walker', False)
                    child_is_lava_glider = getattr(entity, 'is_lava_glider', False)
                    child_is_night_walker = getattr(entity, 'is_night_walker', False)
                    child_is_blizzard_walker = getattr(entity, 'is_blizzard_walker', False)
                    child_is_storm_walker = getattr(entity, 'is_storm_walker', False)
                    child_is_rain_walker = getattr(entity, 'is_rain_walker', False)
                    child_is_volcanic_walker = getattr(entity, 'is_volcanic_walker', False)
                    child_is_earthquake_walker = getattr(entity, "is_earthquake_walker", False)
                    child_is_fire_walker = getattr(entity, "is_fire_walker", False)
                    child_is_drought_walker = getattr(entity, "is_drought_walker", False)
                    child_is_mud_walker = getattr(entity, "is_mud_walker", False)
                    child_is_sand_walker = getattr(entity, "is_sand_walker", False)
                    child_is_water_walker = getattr(entity, "is_water_walker", False)
                    child_is_deep_water_walker = getattr(entity, "is_deep_water_walker", False)
                    child_is_wall_walker = getattr(entity, "is_wall_walker", False)
                    child_is_day_walker = getattr(entity, 'is_day_walker', False)
                    child_is_spring_walker = getattr(entity, 'is_spring_walker', False)
                    child_is_summer_walker = getattr(entity, 'is_summer_walker', False)
                    child_is_autumn_walker = getattr(entity, 'is_autumn_walker', False)
                    child_is_winter_walker = getattr(entity, 'is_winter_walker', False)
                    child_is_shelter_walker = getattr(entity, 'is_shelter_walker', False)
                    if random.random() < mutation_chance:
                        child_is_snow_walker = not child_is_snow_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ice_walker = not child_is_ice_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_lava_walker = not child_is_lava_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_lava_glider = not child_is_lava_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_night_walker = not child_is_night_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_blizzard_walker = not child_is_blizzard_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_walker = not child_is_storm_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_rain_walker = not child_is_rain_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_volcanic_walker = not child_is_volcanic_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_earthquake_walker = not child_is_earthquake_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_fire_walker = not child_is_fire_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_walker = not child_is_drought_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mud_walker = not child_is_mud_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sand_walker = not child_is_sand_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_water_walker = not child_is_water_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_deep_water_walker = not child_is_deep_water_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wall_walker = not child_is_wall_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_day_walker = not child_is_day_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_spring_walker = not child_is_spring_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_summer_walker = not child_is_summer_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_autumn_walker = not child_is_autumn_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_winter_walker = not child_is_winter_walker
                        mutation_occurred = True

                    if random.random() < mutation_chance:
                        child_is_shelter_walker = not child_is_shelter_walker
                        mutation_occurred = True
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mountain_dweller = not child_is_mountain_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_sand_dweller = not child_is_sand_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_forest_dweller = not child_is_forest_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_water_dweller = not child_is_water_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ice_dweller = not child_is_ice_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ash_dweller = not child_is_ash_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_snow_dweller = not child_is_snow_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_mud_dweller = not child_is_mud_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_web_dweller = not child_is_web_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_deep_water_dweller = not child_is_deep_water_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_lava_dweller = not child_is_lava_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_space_dweller = not child_is_space_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_shelter_dweller = not child_is_shelter_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_space_walker = not child_is_space_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_space_glider = not child_is_space_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_space_dancer = not child_is_space_dancer
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_symbiotic = not child_is_symbiotic
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_hive_mind = not child_is_hive_mind
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_shelter_strider = not child_is_shelter_strider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_shelter_dweller = not child_is_shelter_dweller
                        mutation_occurred = True
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_cave_dweller = not child_is_cave_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_wall_dweller = not child_is_wall_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_cave_glider = not child_is_cave_glider
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_cave_walker = not child_is_cave_walker
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_blizzard_dweller = not child_is_blizzard_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_storm_dweller = not child_is_storm_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_day_dweller = not child_is_day_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_night_dweller = not child_is_night_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_spring_dweller = not child_is_spring_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_summer_dweller = not child_is_summer_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_autumn_dweller = not child_is_autumn_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_winter_dweller = not child_is_winter_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_drought_dweller = not child_is_drought_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_earthquake_dweller = not child_is_earthquake_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_volcanic_dweller = not child_is_volcanic_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_fire_dweller = not child_is_fire_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_rain_dweller = not child_is_rain_dweller
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_venom_resistant = not child_is_venom_resistant
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_ageless = not child_is_ageless
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_disease_resistant = not child_is_disease_resistant
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    child_is_hypnotic = getattr(entity, 'is_hypnotic', False)
                    ...
                    if random.random() < mutation_chance:
                        ...
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                        child_is_hypnotic = not child_is_hypnotic
                        mutation_occurred = True
                    if random.random() < mutation_chance:
                    ...
                    child = Entity(name=f"{entity.name}_child", x=child_x, y=child_y,
                                   ...
                                   species=child_species, symbiotic_with=entity.symbiotic_with,
                                   ...
                                   generation=child_generation, mutations=child_mutations_count, max_hydration=child_max_hydration, hydration=child_max_hydration, is_sleeping=False, toxicity=child_toxicity, poison_resistance=child_poison_resistance, camouflage=child_camouflage, vision_type=child_vision_type, is_flying=child_is_flying, can_hibernate=child_can_hibernate, lays_eggs=child_lays_eggs, level=1, experience=0, can_hoard=child_can_hoard, max_stamina=child_max_stamina, stamina=child_max_stamina, is_nocturnal=child_is_nocturnal, can_burrow=child_can_burrow, has_spikes=child_has_spikes, can_spin_webs=child_can_spin_webs, is_venomous=child_is_venomous, can_photosynthesize=child_can_photosynthesize, is_amphibious=child_is_amphibious, has_shell=child_has_shell, has_echolocation=child_has_echolocation, is_aposematic=child_is_aposematic, is_fruiting=child_is_fruiting, is_immune=child_is_immune, is_cold_blooded=child_is_cold_blooded, is_electric=child_is_electric, is_regenerative=child_is_regenerative, has_claws=child_has_claws, is_parasitic=child_is_parasitic, has_scales=child_has_scales, has_fur=child_has_fur, can_climb=child_can_climb, pack_hunter=child_pack_hunter, has_bioluminescence=child_has_bioluminescence, is_volcanic=child_is_volcanic, is_forestal=child_is_forestal, is_desertic=child_is_desertic, is_social=child_is_social, is_carnivorous_plant=child_is_carnivorous_plant, disease_vector=child_disease_vector, is_nocturnal_predator=child_is_nocturnal_predator, is_scentless=child_is_scentless, can_sprint=child_can_sprint, is_vampiric=child_is_vampiric, is_detritivore=child_is_detritivore, can_sweat=child_can_sweat, has_blubber=child_has_blubber, is_mud_bather=child_is_mud_bather, is_filter_feeder=child_is_filter_feeder, is_gluttonous=child_is_gluttonous, is_solitary=child_is_solitary, is_cannibalistic=child_is_cannibalistic, is_ambush_predator=child_is_ambush_predator, is_territorial=child_is_territorial, has_horns=child_has_horns, is_migratory=child_is_migratory, is_cooperative=child_is_cooperative, is_frugivore=child_is_frugivore, is_agile=child_is_agile, has_strong_stomach=child_has_strong_stomach, is_opportunistic=child_is_opportunistic, has_thick_skin=child_has_thick_skin, has_sharp_teeth=child_has_sharp_teeth, is_hardy=child_is_hardy, is_fast_learner=child_is_fast_learner, is_playful=child_is_playful, is_heavy_sleeper=child_is_heavy_sleeper, is_patient=child_is_patient, is_endurance_runner=child_is_endurance_runner, is_evasive=child_is_evasive, is_prolific=child_is_prolific, is_adaptable=child_is_adaptable, is_resourceful=child_is_resourceful, is_vocal=child_is_vocal, is_nest_builder=child_is_nest_builder, is_nomadic=child_is_nomadic, is_photosensitive=child_is_photosensitive, is_fearless=child_is_fearless, is_scavenger=child_is_scavenger, is_scout=child_is_scout, is_intimidating=child_is_intimidating, is_cleaner=child_is_cleaner, is_spiteful=child_is_spiteful, is_sunbather=child_is_sunbather, is_reckless=child_is_reckless, is_thief=child_is_thief, is_absorbent=child_is_absorbent, is_toxic=child_is_toxic, is_vibrant=child_is_vibrant, is_arctic=child_is_arctic, is_fierce=child_is_fierce, is_lucky=child_is_lucky, is_telepathic=child_is_telepathic, is_cautious=child_is_cautious, is_restless=child_is_restless, is_vengeful=child_is_vengeful, is_defensive=child_is_defensive, is_sturdy=child_is_sturdy, is_slippery=child_is_slippery, can_leap=child_can_leap, is_heavy=child_is_heavy, is_lightweight=child_is_lightweight, is_stealthy=child_is_stealthy, is_mimic=child_is_mimic, is_resilient=child_is_resilient, is_smelly=child_is_smelly, is_relentless=child_is_relentless, is_parasite_resistant=child_is_parasite_resistant, is_ruthless=child_is_ruthless, is_protective=child_is_protective, is_forager=child_is_forager, is_tireless=child_is_tireless, is_vigilant=child_is_vigilant, is_pacifist=child_is_pacifist, is_farsighted=child_is_farsighted, is_chameleon=child_is_chameleon, is_bloodthirsty=child_is_bloodthirsty, is_unappetizing=child_is_unappetizing, is_introspective=child_is_introspective, is_frenzied=child_is_frenzied, is_sun_tracker=child_is_sun_tracker, is_hypnotic=child_is_hypnotic, is_tracker=child_is_tracker, is_empathic=child_is_empathic, is_contagious=child_is_contagious, is_arboreal=child_is_arboreal, is_stargazer=child_is_stargazer, is_sure_footed=child_is_sure_footed, is_dust_bather=child_is_dust_bather, is_magnetic=child_is_magnetic, is_drought_resistant=child_is_drought_resistant, is_moon_bather=child_is_moon_bather, is_storm_chaser=child_is_storm_chaser, is_shadow_stalker=child_is_shadow_stalker, is_pyrophilic=child_is_pyrophilic, is_desperate=child_is_desperate, is_iron_willed=child_is_iron_willed, is_frost_walker=child_is_frost_walker, is_marsh_strider=child_is_marsh_strider, is_dune_walker=child_is_dune_walker, is_water_strider=child_is_water_strider, is_web_walker=child_is_web_walker, is_ash_walker=child_is_ash_walker, is_wind_glider=child_is_wind_glider, is_forest_walker=child_is_forest_walker, is_rain_dancer=child_is_rain_dancer, is_fire_dancer=child_is_fire_dancer, is_snow_dancer=child_is_snow_dancer, is_wind_dancer=child_is_wind_dancer, is_stun_dancer=child_is_stun_dancer, is_storm_dancer=child_is_storm_dancer, is_blizzard_dancer=child_is_blizzard_dancer, is_earthquake_dancer=child_is_earthquake_dancer, is_volcanic_dancer=child_is_volcanic_dancer, is_drought_dancer=child_is_drought_dancer, is_spring_dancer=child_is_spring_dancer, is_summer_dancer=child_is_summer_dancer, is_autumn_dancer=child_is_autumn_dancer, is_winter_dancer=child_is_winter_dancer, is_day_dancer=child_is_day_dancer, is_night_dancer=child_is_night_dancer, is_moon_dancer=child_is_moon_dancer, is_weather_sensitive=child_is_weather_sensitive, is_sand_dancer=child_is_sand_dancer, is_cave_dancer=child_is_cave_dancer, is_water_dancer=child_is_water_dancer, is_forest_dancer=child_is_forest_dancer, is_ash_dancer=child_is_ash_dancer, is_mud_dancer=child_is_mud_dancer, is_ice_dancer=child_is_ice_dancer, is_mountain_dancer=child_is_mountain_dancer, is_deep_water_dancer=child_is_deep_water_dancer, is_wall_dancer=child_is_wall_dancer, is_web_dancer=child_is_web_dancer, is_shelter_dancer=child_is_shelter_dancer, is_blizzard_glider=child_is_blizzard_glider, is_seismic_sensitive=child_is_seismic_sensitive, is_mud_glider=child_is_mud_glider, is_drought_strider=child_is_drought_strider, is_earthquake_glider=child_is_earthquake_glider, is_volcanic_glider=child_is_volcanic_glider, is_ice_glider=child_is_ice_glider, is_day_glider=child_is_day_glider, is_night_glider=child_is_night_glider, is_snow_glider=child_is_snow_glider, is_deep_water_glider=child_is_deep_water_glider, is_ash_glider=child_is_ash_glider, is_spring_glider=child_is_spring_glider, is_summer_glider=child_is_summer_glider, is_autumn_glider=child_is_autumn_glider, is_winter_glider=child_is_winter_glider, is_wall_glider=child_is_wall_glider, is_rain_glider=child_is_rain_glider, is_sand_glider=child_is_sand_glider, is_fire_glider=child_is_fire_glider, is_web_glider=child_is_web_glider, is_forest_glider=child_is_forest_glider, is_water_glider=child_is_water_glider, is_shelter_glider=child_is_shelter_glider, is_mountain_walker=child_is_mountain_walker, is_mountain_glider=child_is_mountain_glider, is_mountain_dweller=child_is_mountain_dweller, is_sand_dweller=child_is_sand_dweller, is_forest_dweller=child_is_forest_dweller, is_water_dweller=child_is_water_dweller, is_ice_dweller=child_is_ice_dweller, is_ash_dweller=child_is_ash_dweller, is_snow_dweller=child_is_snow_dweller, is_mud_dweller=child_is_mud_dweller, is_web_dweller=child_is_web_dweller, is_deep_water_dweller=child_is_deep_water_dweller, is_cave_dweller=child_is_cave_dweller, is_wall_dweller=child_is_wall_dweller, is_cave_glider=child_is_cave_glider, is_cave_walker=child_is_cave_walker, is_blizzard_dweller=child_is_blizzard_dweller, is_storm_dweller=child_is_storm_dweller, is_day_dweller=child_is_day_dweller, is_night_dweller=child_is_night_dweller, is_spring_dweller=child_is_spring_dweller, is_summer_dweller=child_is_summer_dweller, is_autumn_dweller=child_is_autumn_dweller, is_winter_dweller=child_is_winter_dweller, is_drought_dweller=child_is_drought_dweller, is_earthquake_dweller=child_is_earthquake_dweller, is_volcanic_dweller=child_is_volcanic_dweller, is_fire_dweller=child_is_fire_dweller, is_rain_dweller=child_is_rain_dweller, is_disease_dweller=child_is_disease_dweller, is_poison_dweller=child_is_poison_dweller, is_venom_resistant=child_is_venom_resistant, is_ageless=child_is_ageless, is_disease_resistant=child_is_disease_resistant, is_parasite_dweller=child_is_parasite_dweller, is_stun_dweller=child_is_stun_dweller, is_sleep_dweller=child_is_sleep_dweller, is_snow_walker=child_is_snow_walker, is_blizzard_walker=child_is_blizzard_walker, is_storm_walker=child_is_storm_walker, is_rain_walker=child_is_rain_walker, is_volcanic_walker=child_is_volcanic_walker, is_earthquake_walker=child_is_earthquake_walker, is_fire_walker=child_is_fire_walker, is_drought_walker=child_is_drought_walker, is_mud_walker=child_is_mud_walker, is_sand_walker=child_is_sand_walker, is_water_walker=child_is_water_walker, is_storm_glider=child_is_storm_glider, is_ice_walker=child_is_ice_walker, is_lava_walker=child_is_lava_walker, is_lava_glider=child_is_lava_glider, is_night_walker=child_is_night_walker, is_deep_water_walker=child_is_deep_water_walker, is_wall_walker=child_is_wall_walker, is_day_walker=child_is_day_walker, is_spring_walker=child_is_spring_walker, is_summer_walker=child_is_summer_walker, is_autumn_walker=child_is_autumn_walker, is_winter_walker=child_is_winter_walker, is_shelter_walker=child_is_shelter_walker, is_drought_glider=child_is_drought_glider, is_lava_dweller=child_is_lava_dweller, is_space_dweller=child_is_space_dweller, is_shelter_dweller=child_is_shelter_dweller, is_poison_dancer=child_is_poison_dancer, is_parasite_dancer=child_is_parasite_dancer, is_sleep_dancer=child_is_sleep_dancer, is_disease_dancer=child_is_disease_dancer, is_grass_dancer=child_is_grass_dancer, is_grass_walker=child_is_grass_walker, is_grass_glider=child_is_grass_glider, is_grass_dweller=child_is_grass_dweller, is_lava_dancer=child_is_lava_dancer, is_space_walker=child_is_space_walker, is_space_glider=child_is_space_glider, is_space_dancer=child_is_space_dancer, is_symbiotic=child_is_symbiotic, is_hive_mind=child_is_hive_mind, is_shelter_strider=child_is_shelter_strider, is_storm_strider=child_is_storm_strider, is_blizzard_strider=child_is_blizzard_strider, is_grass_strider=child_is_grass_strider, is_space_strider=child_is_space_strider, is_marsh_glider=child_is_marsh_glider, is_ash_strider=child_is_ash_strider, is_mud_strider=child_is_mud_strider, is_cave_strider=child_is_cave_strider, is_deep_water_strider=child_is_deep_water_strider, is_forest_strider=child_is_forest_strider, is_ice_strider=child_is_ice_strider, is_lava_strider=child_is_lava_strider, is_mountain_strider=child_is_mountain_strider, is_sand_strider=child_is_sand_strider, is_snow_strider=child_is_snow_strider, is_wall_strider=child_is_wall_strider, is_web_strider=child_is_web_strider, is_earthquake_strider=child_is_earthquake_strider, is_volcanic_strider=child_is_volcanic_strider, is_rain_strider=child_is_rain_strider, is_fire_strider=child_is_fire_strider,
                        is_quicksand_glider=child_is_quicksand_glider,
                                                       is_quicksand_walker=child_is_quicksand_walker,
                                                       is_marsh_dweller=child_is_marsh_dweller, is_marsh_walker=child_is_marsh_walker, is_quicksand_dweller=child_is_quicksand_dweller, is_quicksand_dancer=child_is_quicksand_dancer, is_quicksand_strider=child_is_quicksand_strider, is_marsh_dancer=child_is_marsh_dancer, is_day_strider=child_is_day_strider, is_night_strider=child_is_night_strider, is_spring_strider=child_is_spring_strider, is_summer_strider=child_is_summer_strider, is_autumn_strider=child_is_autumn_strider, is_winter_strider=child_is_winter_strider, is_disease_strider=child_is_disease_strider, is_poison_strider=child_is_poison_strider, is_parasite_strider=child_is_parasite_strider, is_stun_strider=child_is_stun_strider)
                ...
                if getattr(entity, 'is_weather_sensitive', False) and (self.current_event in ['storm', 'blizzard'] or any(e.event_type in ['rain', 'snow'] and (entity.x - e.x)**2 + (entity.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) and effective_perception > 0:
                    effective_perception *= 2
                if getattr(entity, 'is_seismic_sensitive', False) and self.current_event == 'earthquake' and effective_perception > 0:
                    effective_perception *= 3
                ...
                # Dust bather recovering from infection
                if getattr(entity, 'is_dust_bather', False) and getattr(entity, 'is_infected', False):
                    terrains_here = self.get_terrains_at(entity.x, entity.y)
                    if any(t.terrain_type in ['ash', 'sand'] for t in terrains_here):
                        entity.is_infected = False
                        entity.infection_time = 0
                ...
                if getattr(entity, "stunned_time", 0) > 0 and not getattr(entity, 'is_sturdy', False):
                    ...
                    if not getattr(entity, 'is_stun_strider', False):
                        can_move = False
                if entity.is_sleeping:
                    can_move = False
                    ...
                    if getattr(entity, 'host', None) is not None:
                        ...
                        for other in self.entities:
                            if other != entity and other.is_alive and not getattr(other, 'is_parasitic', False) and not getattr(other, 'is_parasite_resistant', False):
                                ...
                                if getattr(entity, 'is_seismic_sensitive', False) and self.current_event == 'earthquake' and actual_perception > 0:
                                    actual_perception *= 3
                ...
                if effective_diet in ['herbivore', 'scavenger']:
                    ...
                    if foods_here:
                        ...
                        if preys_here:
                            ...
                            prey_in_shelter = (getattr(prey_to_eat, 'is_disease_dweller', False) and getattr(prey_to_eat, 'is_infected', False) or (getattr(prey_to_eat, 'is_marsh_dweller', False) and any(t.terrain_type in ('mud', 'water') for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)))) or (getattr(prey_to_eat, 'is_parasite_dweller', False) and len(getattr(prey_to_eat, 'attached_parasites', [])) > 0) or (getattr(prey_to_eat, 'is_poison_dweller', False) and getattr(prey_to_eat, 'poisoned_time', 0) > 0) or (getattr(prey_to_eat, 'is_stun_dweller', False) and getattr(prey_to_eat, 'stunned_time', 0) > 0) or (getattr(prey_to_eat, 'is_sleep_dweller', False) and getattr(prey_to_eat, 'is_sleeping', False)) or (getattr(prey_to_eat, 'is_blizzard_dweller', False) and self.current_event == 'blizzard') or (getattr(prey_to_eat, 'is_drought_dweller', False) and self.current_event == 'drought') or (getattr(prey_to_eat, 'is_earthquake_dweller', False) and self.current_event == 'earthquake') or (getattr(prey_to_eat, 'is_volcanic_dweller', False) and self.current_event == 'volcano') or (getattr(prey_to_eat, 'is_fire_dweller', False) and any(e.event_type == 'fire' and (prey_to_eat.x - e.x)**2 + (prey_to_eat.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(prey_to_eat, 'is_rain_dweller', False) and any(e.event_type == 'rain' and (prey_to_eat.x - e.x)**2 + (prey_to_eat.y - e.y)**2 <= e.radius**2 for e in self.localized_events)) or (getattr(prey_to_eat, 'is_storm_dweller', False) and self.current_event == 'storm') or (getattr(prey_to_eat, 'is_shelter_dweller', False) and any(t.terrain_type == 'shelter' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_arboreal', False) and any(t.terrain_type == 'forest' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_mountain_dweller', False) and any(t.terrain_type in ('mountain', 'cave') for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)))  or (getattr(prey_to_eat, 'is_sand_dweller', False) and any(t.terrain_type == 'sand' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_forest_dweller', False) and any(t.terrain_type == 'forest' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_water_dweller', False) and any(t.terrain_type == 'water' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_ice_dweller', False) and any(t.terrain_type == 'ice' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_ash_dweller', False) and any(t.terrain_type == 'ash' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_snow_dweller', False) and any(t.terrain_type == 'snow' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_mud_dweller', False) and any(t.terrain_type == 'mud' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_web_dweller', False) and any(t.terrain_type == 'web' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_deep_water_dweller', False) and any(t.terrain_type == 'deep-water' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_cave_dweller', False) and any(t.terrain_type == 'cave' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_day_dweller', False) and self.is_day) or (getattr(prey_to_eat, 'is_night_dweller', False) and self.is_night) or (getattr(prey_to_eat, 'is_spring_dweller', False) and self.current_season == 'spring') or (getattr(prey_to_eat, 'is_summer_dweller', False) and self.current_season == 'summer') or (getattr(prey_to_eat, 'is_autumn_dweller', False) and self.current_season == 'autumn') or (getattr(prey_to_eat, 'is_winter_dweller', False) and self.current_season == 'winter') or (getattr(prey_to_eat, 'is_lava_dweller', False) and any(t.terrain_type == 'lava' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_space_dweller', False) and any(t.terrain_type == 'space' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_grass_dweller', False) and any(t.terrain_type == 'grass' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y))) or (getattr(prey_to_eat, 'is_quicksand_dweller', False) and any(q.x == prey_to_eat.x and q.y == prey_to_eat.y for q in self.quicksands))
                            ...
                            if getattr(entity, 'is_storm_chaser', False) and self.current_event == 'storm':
                                effective_attack += 2
                            if getattr(entity, 'is_shadow_stalker', False) and self.is_night:
                                effective_attack += 3
                            ...
                            if getattr(entity, 'is_desperate', False) and getattr(entity, 'energy', 10) < getattr(entity, 'max_energy', 50) * 0.3:
                                effective_attack += 4
                            if getattr(entity, 'stamina', 50) <= 10:
                                effective_attack *= 0.5
                            if getattr(prey_to_eat, 'is_hypnotic', False):
                                effective_attack = max(0, effective_attack // 2)
                            ...
                            if getattr(prey_to_eat, 'is_forestal', False) and any(t.terrain_type == 'forest' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 3
                            if getattr(prey_to_eat, 'is_disease_strider', False) and getattr(prey_to_eat, 'is_infected', False):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_poison_strider', False) and getattr(prey_to_eat, 'poisoned_time', 0) > 0:
                                effective_defense += 2
                            ...
                            if getattr(prey_to_eat, 'is_summer_strider', False) and self.current_season == 'summer':
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_autumn_strider', False) and self.current_season == 'autumn':
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_winter_strider', False) and self.current_season == 'winter':
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_marsh_strider', False) and any(t.terrain_type == 'mud' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_mud_strider', False) and any(t.terrain_type == 'mud' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 2
                            ...
                            if getattr(prey_to_eat, 'is_drought_strider', False) and self.current_event == 'drought':
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_rain_strider', False) and any(e.event_type == 'rain' and (prey_to_eat.x - e.x)**2 + (prey_to_eat.y - e.y)**2 <= e.radius**2 for e in self.localized_events):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_fire_strider', False) and any(e.event_type == 'fire' and (prey_to_eat.x - e.x)**2 + (prey_to_eat.y - e.y)**2 <= e.radius**2 for e in self.localized_events):
                                effective_defense += 2
                            ...
                            if getattr(prey_to_eat, 'is_storm_strider', False) and self.current_event == 'storm':
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_earthquake_strider', False) and self.current_event == 'earthquake':
                                effective_defense += 2
                            ...
                            if getattr(prey_to_eat, 'is_sand_strider', False) and any(t.terrain_type == 'sand' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_quicksand_strider', False) and any(q.x == prey_to_eat.x and q.y == prey_to_eat.y for q in self.quicksands):
                                effective_defense += 2
                            ...
                            if prey_in_shelter:
                                effective_defense += 3
                            if getattr(prey_to_eat, 'is_shelter_dweller', False) and any(t.terrain_type == 'shelter' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_shelter_dweller', False) and any(t.terrain_type == 'shelter' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                                effective_defense += 2
                            if getattr(prey_to_eat, 'is_intimidating', False) and not getattr(entity, 'is_iron_willed', False):
                                effective_attack = max(0, effective_attack - 2)
                            if getattr(prey_to_eat, 'is_smelly', False) and not getattr(entity, 'is_iron_willed', False):
                                effective_attack = max(0, effective_attack - 2)
                            if getattr(entity, 'is_intimidating', False) and not getattr(prey_to_eat, 'is_iron_willed', False):
                                effective_defense = max(0, effective_defense - 2)
                            ...
                            if getattr(entity, 'is_infected', False) and getattr(entity, 'is_contagious', False) and not getattr(prey_to_eat, 'is_immune', False):
                                prey_to_eat.is_infected = True
                                prey_to_eat.infection_time = 0
                            if getattr(prey_to_eat, 'is_infected', False) and getattr(prey_to_eat, 'is_contagious', False) and not getattr(entity, 'is_immune', False):
                                entity.is_infected = True
                                entity.infection_time = 0
                            ...
                            if getattr(entity, 'is_venomous', False) and random.random() < 0.5:
                                if not getattr(prey_to_eat, 'is_venom_resistant', False):
                            ...
                            if getattr(prey_to_eat, 'is_venomous', False) and random.random() < 0.5:
                                if not getattr(entity, 'is_venom_resistant', False):
                    ...
                    if preys_here:
                        ...
                        if getattr(prey_to_eat, 'is_quicksand_strider', False) and any(q.x == prey_to_eat.x and q.y == prey_to_eat.y for q in self.quicksands):
                            effective_defense += 2
                        if getattr(prey_to_eat, 'is_shelter_strider', False) and any(t.terrain_type == 'shelter' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)):
                            effective_defense += 2
                        if getattr(prey_to_eat, 'has_shell', False):
                            effective_defense += 5
                        if getattr(prey_to_eat, 'has_horns', False):
