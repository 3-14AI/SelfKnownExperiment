        ...
        for entity in self.entities:
            ...
            if getattr(entity, 'is_hibernating', False):
                ...
                if not (entity.preferred_temperature - effective_tolerance <= current_temp <= entity.preferred_temperature + effective_tolerance):
                    if current_temp > entity.preferred_temperature + effective_tolerance and getattr(entity, 'can_sweat', False) and entity.hydration > 5:
            ...
            if entity.is_alive:
                ...
                sprinting_now = False
                if can_move == False and getattr(entity, 'can_sprint', False) and entity.stamina >= 10 and getattr(entity, "stunned_time", 0) <= 0 and not entity.is_sleeping:
                    can_move = True
                    sprinting_now = True
