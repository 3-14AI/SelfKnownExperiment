...
class Universe:
    ...
    def tick(self):
        ...
        for entity in self.entities:
            ...
            in_shelter = any(t.terrain_type == 'shelter' for t in terrains_here) or (getattr(entity, 'can_burrow', False) and entity.is_sleeping) or (getattr(entity, 'is_arboreal', False) and any(t.terrain_type == 'forest' for t in terrains_here))
                ...
                if effective_diet in ['herbivore', 'scavenger']:
                    ...
                    if foods_here:
                        ...
                        if preys_here:
                            ...
                            prey_in_shelter = any(t.terrain_type == 'shelter' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)) or (getattr(prey_to_eat, 'is_arboreal', False) and any(t.terrain_type == 'forest' for t in self.get_terrains_at(prey_to_eat.x, prey_to_eat.y)))
