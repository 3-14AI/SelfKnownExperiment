        ...
        for entity in self.entities:
            ...
            if getattr(entity, 'is_hibernating', False):
                ...
                if self.current_event == 'storm':
                    if getattr(entity, 'is_storm_chaser', False):
                        energy_loss = 0
                        entity.energy = min(int(entity.max_energy * 1.5) if getattr(entity, "is_gluttonous", False) else entity.max_energy, entity.energy + 3)
                        entity.stamina = getattr(entity, 'max_stamina', 50)
                    else:
