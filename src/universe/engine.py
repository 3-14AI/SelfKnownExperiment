...
class Universe:
    ...
    def is_passable(self, x, y, is_aquatic=False, is_flying=False, is_amphibious=False, is_climbing=False, is_water_strider=False, is_wall_strider=False, is_deep_water_strider=False, is_web_strider=False, is_mud_strider=False):
    ...
    def find_path(self, start_x, start_y, target_x, target_y, max_distance=None, memory=None, is_aquatic=False, is_flying=False, is_amphibious=False, is_climbing=False, can_leap=False, is_water_strider=False, is_wall_strider=False, is_deep_water_strider=False, is_web_strider=False, is_mud_strider=False):
                ...
                if (new_x, new_y) not in visited:
                    if 0 <= new_x < self.width and 0 <= new_y < self.height:
                        ...
                        # Ignore obstacles beyond perception radius
                            ...
                            if self.is_passable(new_x, new_y, is_aquatic, is_flying, is_amphibious, is_climbing, is_water_strider=is_water_strider, is_wall_strider=is_wall_strider, is_deep_water_strider=is_deep_water_strider, is_web_strider=is_web_strider, is_mud_strider=is_mud_strider):
                                visited.add((new_x, new_y))
                                queue.append((new_x, new_y, path + [(dx, dy)]))
                            elif can_leap:
                                leap_x, leap_y = new_x + dx, new_y + dy
                                if (leap_x, leap_y) not in visited and 0 <= leap_x < self.width and 0 <= leap_y < self.height:
                                    if self.is_passable(leap_x, leap_y, is_aquatic, is_flying, is_amphibious, is_climbing, is_water_strider=is_water_strider, is_wall_strider=is_wall_strider, is_deep_water_strider=is_deep_water_strider, is_web_strider=is_web_strider, is_mud_strider=is_mud_strider):
                        ...
                        if entity.alerted_predator_pos:
                            ...
                            for dx, dy in [(0, -1), (0, 1), (-1, 0), (1, 0)]:
                                ...
                                try:
                                    ...
                                    if 0 <= nx < self.width and 0 <= ny < self.height:
                                        if self.is_passable(nx, ny, getattr(entity, 'is_aquatic', False), getattr(entity, 'is_flying', False), getattr(entity, 'is_amphibious', False), is_climbing=getattr(entity, 'can_climb', False), is_water_strider=getattr(entity, 'is_water_strider', False), is_wall_strider=getattr(entity, 'is_wall_strider', False), is_deep_water_strider=getattr(entity, 'is_deep_water_strider', False), is_web_strider=getattr(entity, 'is_web_strider', False), is_mud_strider=getattr(entity, 'is_mud_strider', False), ) or (getattr(entity, 'can_leap', False) and getattr(entity, 'stamina', 0) >= 5 and self.is_passable(entity.x + dx * 2, entity.y + dy * 2, getattr(entity, 'is_aquatic', False), getattr(entity, 'is_flying', False), getattr(entity, 'is_amphibious', False), is_climbing=getattr(entity, 'can_climb', False), is_water_strider=getattr(entity, 'is_water_strider', False), is_wall_strider=getattr(entity, 'is_wall_strider', False), is_deep_water_strider=getattr(entity, 'is_deep_water_strider', False), is_web_strider=getattr(entity, 'is_web_strider', False), is_mud_strider=getattr(entity, 'is_mud_strider', False), )):
                                ...
                                if target_to_chase:
                                    ...
                                    for dx, dy in search_radius:
                                        ...
                                        if (nx, ny) in self.scent_trails and self.scent_trails[(nx, ny)] > best_scent:
                                            ...
                                            if self.is_passable(check_nx, check_ny, getattr(entity, 'is_aquatic', False), getattr(entity, 'is_flying', False), getattr(entity, 'is_amphibious', False), is_climbing=getattr(entity, 'can_climb', False), is_water_strider=getattr(entity, 'is_water_strider', False), is_wall_strider=getattr(entity, 'is_wall_strider', False), is_deep_water_strider=getattr(entity, 'is_deep_water_strider', False), is_web_strider=getattr(entity, 'is_web_strider', False), is_mud_strider=getattr(entity, 'is_mud_strider', False), ) or (getattr(entity, 'can_leap', False) and getattr(entity, 'stamina', 0) >= 5 and self.is_passable(entity.x + step_dx * 2, entity.y + step_dy * 2, getattr(entity, 'is_aquatic', False), getattr(entity, 'is_flying', False), getattr(entity, 'is_amphibious', False), is_climbing=getattr(entity, 'can_climb', False), is_water_strider=getattr(entity, 'is_water_strider', False), is_wall_strider=getattr(entity, 'is_wall_strider', False), is_deep_water_strider=getattr(entity, 'is_deep_water_strider', False), is_web_strider=getattr(entity, 'is_web_strider', False), is_mud_strider=getattr(entity, 'is_mud_strider', False), )):
