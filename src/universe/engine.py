    ...
    def move_entity(self, entity, dx, dy):
        ...
        if hasattr(entity, 'stamina'):
            ...
            if getattr(entity, 'is_blizzard_glider', False) and self.current_event == 'blizzard':
                stamina_cost = 0
            if getattr(entity, 'is_blizzard_dancer', False) and self.current_event == 'blizzard':
                stamina_cost = 0
