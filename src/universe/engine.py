...
class Universe:
    ...
    def tick(self):
        ...
        for entity in self.entities:
            ...
            if getattr(entity, 'is_blizzard_dancer', False) and getattr(self, 'current_event', None) == 'blizzard':
                energy_loss = 0
