                ...
                if effective_diet in ['herbivore', 'scavenger']:
                    ...
                    if foods_here:
                        ...
                        if preys_here:
                            ...
                            if getattr(entity, 'is_venomous', False) and random.random() < 0.5 and not getattr(prey_to_eat, 'is_venom_resistant', False):
                                prey_to_eat.poisoned_time += max(0, 10 - prey_to_eat.poison_resistance * 2)
                            if getattr(prey_to_eat, 'is_venomous', False) and random.random() < 0.5 and not getattr(entity, 'is_venom_resistant', False):
