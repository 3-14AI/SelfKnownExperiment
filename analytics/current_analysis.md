...
- Updated `Universe.move_entity()` to reduce movement stamina cost to 0 when `entity.is_rain_glider` is True and the entity is inside a 'rain' `LocalizedEvent`.
...
## Implementation of is_cave_walker trait
