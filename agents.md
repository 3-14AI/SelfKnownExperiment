...
- [x] Implemented `is_fire_dancer` trait. Entities with this trait gain energy and are immune to damage when inside a fire event.- [x] Implemented `is_snow_dancer` trait. Entities with this trait gain energy when inside a snow event.
