...
## Next Steps
- Implement a genetics/mutation system where offspring have slight variations in attributes (e.g. max_age, perception_radius, energy) compared to their parents.
